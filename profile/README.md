...
| └ [panel-agent](https://github.com/Glyndor/panel-agent) | Hardened agent on each managed server — Ed25519-signed commands over WireGuard + mTLS | 🟢 Released |
| [**podup**](https://github.com/Glyndor/podup) | `docker-compose` translated to rootless Podman — Rust library + drop-in CLI | 🟢 Released |
| [**mail**](https://github.com/Glyndor/mail) | Headless self-hosted mail server — SMTP/IMAP, DKIM/SPF/DMARC, API + CLI | 🟡 In development |
